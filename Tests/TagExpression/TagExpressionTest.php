...
class TagExpressionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return [
            [[1 => 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890@@@@@@@@@@:::::::::::___________..........#########-------']],
            [[2 => 'tag_1 || tag_2 || tag_3 || tag_4 || tag_5 || tag_6 || tag_7 || tag_8 || tag_9 || tag_10 || tag_11 || tag_12 || tag_13 || tag_14 || tag_15 || tag_16 || tag_17 || tag_18 || tag_19 || tag_20']],
            [[3 => 'tag_1 && tag_2 && tag_3 && tag_4 && tag_5 && tag_6']],
            [[4 => '(tag_1 && tag_2) || (tag_3 && tag_4)']],
            [[5 => 'tag_1 && (tag_2 || tag_3) && tag_4']],
            [[6 => 'tag_1 && tag_2 || tag_3 && tag_4']],
            [[7 => '!tag_1']],
            [[8 => 'tag_1 || !tag_2 || tag_3 || tag_4']],
            [[9 => 'tag_1 && tag_2 && !tag_3']],
            [[10 => 'follows_RedSox || follows_Cardinals || (follow_Marines && location_Boston)']],
        ];
    }
    ...
    public function invalidTagExpressionProvider()
    {
        return [
            // invalid length
            ['0ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890@@@@@@@@@@:::::::::::___________..........#########-------'],
            // invalid character '?'
            ['android?4'],
            // invalid character '~'
            ['tag~2'],
            ...
            ['tag_1 || tag_2 || tag_3 || tag_4 || tag_5 || tag_6 || tag_7 || tag_8 || tag_9 || tag_10 || tag_11 || tag_12 || tag_13 || tag_14 || tag_15 || tag_16 || tag_17 || tag_18 || tag_19 || tag_20 || tag_21'],
